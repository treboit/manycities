...
const DEFAULT_CONFIG = {
    ...
    cities: [
        { id: "sf",    name: "San Francisco", timezone: "America/Los_Angeles", lat: 37.77,  lon: -122.41, workStart: 9, workEnd: 18, visible: true },
        { id: "austin",name: "Austin",        timezone: "America/Chicago",     lat: 30.26,  lon: -97.74,  workStart: 9, workEnd: 18, visible: true },
        { id: "sp",    name: "Sao Paulo",     timezone: "America/Sao_Paulo",   lat: -23.55, lon: -46.63,  workStart: 9, workEnd: 18, visible: true },
        { id: "ams",   name: "Amsterdam",     timezone: "Europe/Amsterdam",    lat: 52.36,  lon: 4.90,    workStart: 9, workEnd: 18, visible: true },
        { id: "bcn",   name: "Barcelona",     timezone: "Europe/Madrid",       lat: 41.38,  lon: 2.16,    workStart: 9, workEnd: 18, visible: true },
        { id: "yer",   name: "Yerevan",       timezone: "Asia/Yerevan",        lat: 40.18,  lon: 44.51,   workStart: 9, workEnd: 18, visible: true }
    ]
};
